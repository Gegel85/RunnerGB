...
SPIKES             EQU $C00B ; RB 7
SPAWN_COUNTER      EQU $C012 ; RB 1
MAX_SCROLL         EQU $C013 ; RB 1
CURRENT_SCROLL     EQU $C014 ; RB 1
SCROLL_COUNTER     EQU $C015 ; RB 1
MAX_SCROLL_COUNTER EQU $C016 ; RB 1
PLAYING_SFX_TIMERS EQU $C017 ; RB 4
NB_REPEATED        EQU $C02B ; RB 1
PLAYING_MUSICS     EQU $C02C ; RB MUSIC_STRUCT_SIZE * 4
