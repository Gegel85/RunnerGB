...
GROUND_POS_X8       EQU $C054 ; RB 25
LEFT_MAP_PTR        EQU $C06D ; RB 1
RIGHT_MAP_PTR       EQU $C06E ; RW 1
SCROLL_PAST_TILE    EQU $C070 ; RB 1
BG_1_POS	   EQU $C071 ; RB 1
BG_1_POS_COUNTER    EQU $C072 ; RB 1
BG_2_POS	   EQU $C073 ; RB 1
CLOCK_ANIM	 EQU $C074 ; RB 1
