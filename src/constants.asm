...
SPIKES             EQU $C00B ; RB 32
SPAWN_COUNTER      EQU $C02B ; RB 1
MAX_SCROLL         EQU $C02C ; RB 1
CURRENT_SCROLL     EQU $C02D ; RB 1
SCROLL_COUNTER     EQU $C02E ; RB 1
MAX_SCROLL_COUNTER EQU $C02F ; RB 1
PLAYING_SFX_TIMERS EQU $C030 ; RB 4
NB_REPEATED        EQU $C034 ; RB 1
PLAYING_MUSICS     EQU $C035 ; RB MUSIC_STRUCT_SIZE * 4
