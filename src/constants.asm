...
GROUND_POS          EQU $C054 ; RB 21
GROUND_POS_X8       EQU $C069 ; RB 21
LEFT_MAP_PTR        EQU $C07E ; RW 1
LEFT_MAP_SRC_TILES  EQU $C080 ; RW 1
RIGHT_MAP_PTR       EQU $C082 ; RW 1
RIGHT_MAP_SRC_TILES EQU $C084 ; RW 1
